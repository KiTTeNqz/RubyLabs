...
studList = StudentListTxt.new()
studList.read_from_txt('/home/dmitry/RubyLabs/Lab2/studentsRead.txt')

short_studs = []
studList.students.each do |stud|
...
StudentListTxt.write_to_txt(studList.students, '/home/dmitry/RubyLabs/Lab2/students1.txt')
